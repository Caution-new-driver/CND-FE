...
const RECOMMENDED_SCENARIO_TYPE = 'WITH_LUGGAGE_TAG'

function itemsLabel(scenario: ProductionScenarioResponse) {
            ...
            <>
              ...
              {showConfirmNotice && (
                <FormMessage variant="muted">
                  Drop 확정 API(b13/b14)가 아직 준비되지 않았습니다. 제작안 선택까지만 저장됩니다.
                </FormMessage>
              )}
            </>
          )}
